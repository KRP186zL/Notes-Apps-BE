 ...
 */
exports.up = (pgm) => {
  //// Untuk mengatasi kolom user yang sebelumnya adalah NULL (kita tidak bisa langsung mengubah owner menjadi NOT NULL, migrate tidak akan dijalankan karena kolom owner sebelumnya bernilai NULL)
